<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="MODIFICAR_NOVEDADES.aspx.cs" Inherits="TPCuatrimestral_Grupo3.MODIFICAR_NOVEDADES" %>
       ...
       <div class="row pt-5">
           ...
           <div class="col">
               ...
               <div class="pt-4">
                   ...
                   <div>
                       <asp:TextBox ID="TxtContenido" TextMode="MultiLine" class="form-control" runat="server" Height="500px" Width="400px" Font-Size="Medium" Font-Bold="True"></asp:TextBox>
                   </div>
               </div>
